...
select Fname +' '+Lname as name , Pname , d.Dnum FROM Employee  as emp inner join Works_for as w on emp.SSN = w.ESSn 
	inner join Project as p on w.Pno = p.Pnumber inner join 
